...
export default function Home() {
  ...
  const handleContactSubmit = (event) => {
    ...
    emailjs.send("service_k55cosk", "template_arnm3hj", {
      ...
      message: `Project type: ${contactForm.projectType || "Not selected"}\nEngagement: ${contactForm.engagementType || "Not selected"}\n\n${contactForm.message}`,
  ...
  return (
    <>
      ...
      <section id="wordpress" className="wordpress-showcase section-block"><div className="section-intro" data-reveal><span className="eyebrow">WordPress & web design</span><h2>Selected website mockups.</h2></div><WordpressStrip /></section>
